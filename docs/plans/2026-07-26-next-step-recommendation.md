...
> **주의(2026-07-27):** 아래 시드 근거는 V71 기준으로 산정된 것이다. V72(태그 확장 — is_key 조건 제거·신규 5종)가 머지되어 상품별 태그가 크게 늘었으므로, 착수 시 V72 반영 후 실데이터로 근거·기대값을 재산정하라. *(2026-07-27 Task 5에서 재산정 완료 — V75 헤더 주석 참조.)*
